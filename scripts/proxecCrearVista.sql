...
insert into anho (anhAnho,anhEst) values('2014/2015',1);
insert into anho (anhAnho,anhEst) values('2013/2014',0);


-- OPERACIONES EVALUACION

insert into evaluacion (evaAnhId, evaNom, evaFec,evaEst) values((select anhId from anho where anhAnho = '2014/2015'),'primera evaluación','2014-12-20 15:00:00',1);
insert into evaluacion (evaAnhId, evaNom, evaFec,evaEst) values((select anhId from anho where anhAnho = '2014/2015'),'segunda evaluación','2015-03-21 15:00:00',1);
insert into evaluacion (evaAnhId, evaNom, evaFec,evaEst) values((select anhId from anho where anhAnho = '2014/2015'),'tercera evaluacion','2015-06-05 15:00:00',1);


-- OPERACIONES CICLO

insert into ciclo (cicNom,cicEst) values('Desarrollo web',1);
insert into ciclo (cicNom,cicEst) values('Sistema',1);
...
insert into asignatura (asiCicID, asiNom, asiEst) values((select cicID from ciclo where cicNom = 'Desarrollo web'),'Contornos',1);
insert into asignatura (asiCicID, asiNom, asiEst) values((select cicID from ciclo where cicNom = 'Desarrollo web'),'Desenvolvemento cliente',1);
insert into asignatura (asiCicID, asiNom, asiEst) values((select cicID from ciclo where cicNom = 'Desarrollo web'),'Despregamento',1);
insert into asignatura (asiCicID, asiNom, asiEst) values((select cicID from ciclo where cicNom = 'Desarrollo web'),'Formación y orientación laboral',1);
insert into asignatura (asiCicID, asiNom, asiEst) values((select cicID from ciclo where cicNom = 'Desarrollo web'),'Programación',1);
insert into asignatura (asiCicID, asiNom, asiEst) values((select cicID from ciclo where cicNom = 'Desarrollo web'),'Desenvolvemento Servidor',1);

insert into asignatura (asiCicID, asiNom, asiEst) values((select cicID from ciclo where cicNom = 'Sistema'),'Lenguaxe de marcas',1);
insert into asignatura (asiCicID, asiNom, asiEst) values((select cicID from ciclo where cicNom = 'Sistema'),'Empresa e iniciativa',1);
insert into asignatura (asiCicID, asiNom, asiEst) values((select cicID from ciclo where cicNom = 'Sistema'),'Seguridad',1);
insert into asignatura (asiCicID, asiNom, asiEst) values((select cicID from ciclo where cicNom = 'Sistema'),'Formación y orientación laboral',1);
insert into asignatura (asiCicID, asiNom, asiEst) values((select cicID from ciclo where cicNom = 'Sistema'),'Bases de Datos',1);


insert into asignatura (asiCicID, asiNom, asiEst) values((select cicID from ciclo where cicNom = 'Desarrollo web'),'Lenguaxe de marcas',1);
...
insert into usuario ( usuNom, usuApe, usuDni, usuTel, usuDir, usuPob, usuPas, usuEst)
				values('Dios', 'Perez', '00000000z', '000000000', 'Cielo, S/n','Cielo','Abcd1234.',1);
insert into usuario ( usuNom, usuApe, usuDni, usuTel, usuDir, usuPob, usuPas,  usuEst)
				values('Alberto', 'García Cid', '22222222z', '981981981', 'Alexander von Humbolt 9-1b','A Coruña','Abcd1234.',1);
insert into usuario ( usuNom, usuApe, usuDni, usuTel, usuDir, usuPob, usuPas,  usuEst)
				values('Manuel', 'Corbelle', '33333333z', '888888888', 'Ronda de nelle, 125','Oleiros','Abcd1234.',1);
insert into usuario ( usuNom, usuApe, usuDni, usuTel, usuDir, usuPob, usuPas,  usuEst)
				values('Mala', 'Rodriguez', '44444444z', '666666666', 'Real, 125','Oleiros','Abcd1234.',1);
insert into usuario ( usuNom, usuApe, usuDni, usuTel, usuDir, usuPob, usuPas,  usuEst)
				values('Vito', 'Corleone', '55555555z', '555666666', 'Ferradal, 63','A Coruña','Abcd1234.',1);
insert into usuario ( usuNom, usuApe, usuDni, usuTel, usuDir, usuPob, usuPas,  usuEst)
				values('Rosalia', 'Rey', '66666666z', '985632147', 'Porta do Sur, 75','A Coruña','Abcd1234.',1);
insert into usuario ( usuNom, usuApe, usuDni, usuTel, usuDir, usuPob, usuPas,  usuEst)
				values('Pepa', 'Pepita', '99999999z', '881415415', 'Sinforiano Lopez, 8','A Coruña','Abcd1234.',0);
insert into usuario ( usuNom, usuApe, usuDni, usuTel, usuDir, usuPob, usuPas,  usuEst)
				values('Santi', 'Souto', '88888888z', '000077700', 'Caballeros, S/n','A Coruña','Abcd1234.',1);
                

                
-- OPERACIONES ROL

insert into rol (rolNom,rolEst) values('Profesor',1);
insert into rol (rolNom,rolEst) values('Alumno',1);
insert into rol (rolNom,rolEst) values('Dios',1);
insert into rol (rolNom,rolEst) values('Administrador',1);
...
insert into rol_usu (rolUsu_usuID,rolUsu_rolID) 
				values((select usuId from usuario where usuDni = '22222222z'),
                       (select rolId from rol where rolNom = 'Alumno'));
insert into rol_usu (rolUsu_usuID,rolUsu_rolID) 
				values((select usuId from usuario where usuDni = '33333333z'),
                       (select rolId from rol where rolNom = 'Profesor'));
insert into rol_usu (rolUsu_usuID,rolUsu_rolID) 
				values((select usuId from usuario where usuDni = '44444444z'),
                       (select rolId from rol where rolNom = 'Alumno'));
insert into rol_usu (rolUsu_usuID,rolUsu_rolID) 
				values((select usuId from usuario where usuDni = '55555555z'),
                       (select rolId from rol where rolNom = 'Alumno'));
insert into rol_usu (rolUsu_usuID,rolUsu_rolID) 
				values((select usuId from usuario where usuDni = '66666666z'),
                       (select rolId from rol where rolNom = 'Alumno'));
insert into rol_usu (rolUsu_usuID,rolUsu_rolID) 
				values((select usuId from usuario where usuDni = '99999999z'),
                       (select rolId from rol where rolNom = 'Administrador'));
insert into rol_usu (rolUsu_usuID,rolUsu_rolID) 
				values((select usuId from usuario where usuDni = '88888888z'),
                       (select rolId from rol where rolNom = 'Profesor'));
...
insert asi_pro (asiPro_anhId,asiPro_asiID,asiPro_usuId)
			values(	(select anhId from anho where anhAnho = '2014/2015'),
					...
					(select usuId from usuario where usuDni = '88888888z'));
...
insert asi_pro (asiPro_anhId,asiPro_asiID,asiPro_usuId)
			values(	(select anhId from anho where anhAnho = '2014/2015'),
					...
					(select usuId from usuario where usuDni = '33333333z'));
